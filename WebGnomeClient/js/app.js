            ...
            if (webgnome.idleTime >= webgnome.config.afk_timeout) {
                ...
                if (_.isUndefined(webgnome.sessionSWAL) ||
                    ...
                    swal({
                        ...
                        text: ('Tú sesión ha estado inactiva por más de una hora' +
                               'La configuración del modelo será borrada automáticamente \n' +
                               'después de 72 horas de inactividad.\n' +
                               '¿Te gustaría continuar con esta configuración?'),
                        type: 'warning',
                        showCancelButton: true,
                        cancelButtonText: 'Reiniciar sesión',
