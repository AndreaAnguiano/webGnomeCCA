define([
    ...
    var beachedForm = FormModal.extend({
        ...
        title: 'Petróleo varado observado',
        buttons: '<button type="button" class="cancel" data-dismiss="modal">Cancelar</button><button type="button" class="delete">Borrar</button><button type="button" class="save">Guardar</button>',
